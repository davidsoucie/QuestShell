...
class TourGuideConverter:
    ...
    def parse_kill_objectives(self, text, coords):
        ...
        # Pattern to catch "Kill 7 Young Nightsaber and 4 Young Thistle Boar"
        # Extract the kill instruction part before location
        ...
        # "7 Young Nightsaber and 4 Young Thistle Boar"
        # "7 Mangy Nightsaber and 7 Thistle Boar"
        ...
        for i, part in enumerate(and_parts):
            part = part.strip()
            # Extract number and mob name: "7 Young Nightsaber"
            ...
            if match:
                ...
                if coords:
                    if len(coords) == 1:
                        ...
                        # Map coordinates 1:1 with objectives
                        objective['coords'] = coords[i]
                    elif len(coords) > 1:
                        # Multiple coordinates for single objective
                        objective['coords'] = coords
    ...
    def parse_step(self, step_text, line_number=None):
        ...
        # Extract step type
        step_type_match = re.match(r'^([ACTLNRhF])\s+', step_text)
    ...
    def convert(self, content, guide_name=None, min_level=1, max_level=60, zone="Unknown"):
        ...
        for i, step in enumerate(steps):
            ...
            # Special properties
            for prop in ['class', 'race', 'zone', 'itemId', 'level']:
                if prop in step:
